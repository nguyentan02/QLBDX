...
router.post('/', auth, validate(createVehicleSchema), (req, res) => vehicleController.create(req, res));
router.put('/:id', auth, validate(updateVehicleSchema), (req, res) => vehicleController.update(req, res));
router.delete('/:id', auth, (req, res) => vehicleController.delete(req, res));
